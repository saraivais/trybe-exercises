...
console.log(terceiroObjeto);

// Exercício 2~

const { name: herName, age, nationality, profession, squad, squadInitials } = terceiroObjeto;

const frase = `Hi, my name is ${herName}, I'm ${age} years old and I'm ${nationality}. I work as a ${profession} and my squad is ${squadInitials}-${squad}`;
